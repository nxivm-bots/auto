...
class Var:
    ...
    FSUB_LINK_EXPIRY = int(getenv("FSUB_LINK_EXPIRY") or 0)
    ...
    OWNER_ID = list(map(int, getenv("ADMINS", "1242011540").split()))
    ...
    START_BUTTONS = getenv("START_BUTTONS", "UPDATES|https://telegram.me/Codeflix_bots SUPPORT|https://t.me/rohit_1888")
